package practice_2_lagutkin.task3;
...
public class ChecksumCalculator {
    ...
    public static void main(String[] args) {
        String filePath = "C:\\Users\\nikit\\IdeaProjects\\practice1-rcsp\\src\\practice_2_lagutkin\\task3\\test.txt"; // Путь к файлу, для которого нужно вычислить контрольную сумму
        try {
